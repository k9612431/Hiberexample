			...
			<%
				...
				for (Files file : files) {
					...
					String form = "<form action='FilesHandler' method='post'>"
							+ "<table><tr>"
							+ "<td>Label:</td><td> <input type='text' name='label' value='"+file.getLabel()+"' /><br/><br/></td></tr>"
							+ "<td>Caption:</td><td> <input type='text' name='caption' value='"+file.getCaption()+"' /><br/><br/></td></tr>"
							+ "</table><br/>"
